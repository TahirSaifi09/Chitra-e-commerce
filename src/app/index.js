  ...
  return (
    <div>
      <div className="flex justify-center mt-4 ">
        <div className=" w-3/5 lg:w-4/5 lg:h-full md:w-4/4 max-md:w-screen max-md:p-6 max-md:w-screen max-md:p-6 max-xl:w-screen max-xl:p-10">
          ...
          <div className="flex justify-between gap-10 mt-12 max-md:flex-wrap">
            <div className="w-1/12 h-full max-md:hidden max-md:hidden">
            <Link to="/">
